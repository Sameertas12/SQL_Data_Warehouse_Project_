...
SELECT * FROM silver.erp_cust_az12 WHERE bdate>CURDATE();
...
-- Using regular expression in cntry column, in case statement, United States becomes UnitedStates
-- Hence in case statement it is compared so.
